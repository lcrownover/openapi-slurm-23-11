...
// checks if the V0040Node type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0040Node{}

// V0040Node struct for V0040Node
...
// SetBootTime gets a reference to the given V0040Uint64NoVal and assigns it to the BootTime field.
...
// SetFreeMem gets a reference to the given V0040Uint64NoVal and assigns it to the FreeMem field.
...
// SetEnergy gets a reference to the given V0040AcctGatherEnergy and assigns it to the Energy field.
...
// SetLastBusy gets a reference to the given V0040Uint64NoVal and assigns it to the LastBusy field.
...
// SetReasonChangedAt gets a reference to the given V0040Uint64NoVal and assigns it to the ReasonChangedAt field.
...
// SetResumeAfter gets a reference to the given V0040Uint64NoVal and assigns it to the ResumeAfter field.
...
// SetSlurmdStartTime gets a reference to the given V0040Uint64NoVal and assigns it to the SlurmdStartTime field.
...
func (o V0040Node) MarshalJSON() ([]byte, error) {
...
func (o V0040Node) ToMap() (map[string]interface{}, error) {
...
type NullableV0040Node struct {
	value *V0040Node
	isSet bool
}

func (v NullableV0040Node) Get() *V0040Node {
	return v.value
}

func (v *NullableV0040Node) Set(val *V0040Node) {
	v.value = val
	v.isSet = true
}

func (v NullableV0040Node) IsSet() bool {
	return v.isSet
}

func (v *NullableV0040Node) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0040Node(val *V0040Node) *NullableV0040Node {
	return &NullableV0040Node{value: val, isSet: true}
}

func (v NullableV0040Node) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0040Node) UnmarshalJSON(src []byte) error {
	v.isSet = true
