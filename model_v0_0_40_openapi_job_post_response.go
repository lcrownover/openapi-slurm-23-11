...
// checks if the V0040OpenapiJobPostResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0040OpenapiJobPostResponse{}

// V0040OpenapiJobPostResponse struct for V0040OpenapiJobPostResponse
type V0040OpenapiJobPostResponse struct {
	Results []V0040JobArrayResponseMsgEntry `json:"results,omitempty"`
...
func NewV0040OpenapiJobPostResponse() *V0040OpenapiJobPostResponse {
	this := V0040OpenapiJobPostResponse{}
	return &this
}
...
func (o *V0040OpenapiJobPostResponse) GetResults() []V0040JobArrayResponseMsgEntry {
	if o == nil || IsNil(o.Results) {
		var ret []V0040JobArrayResponseMsgEntry
		return ret
	}
	return o.Results
}
...
// SetResults gets a reference to the given []V0040JobArrayResponseMsgEntry and assigns it to the Results field.
...
func (o V0040OpenapiJobPostResponse) MarshalJSON() ([]byte, error) {
...
func (o V0040OpenapiJobPostResponse) ToMap() (map[string]interface{}, error) {
...
type NullableV0040OpenapiJobPostResponse struct {
	value *V0040OpenapiJobPostResponse
	isSet bool
}

func (v NullableV0040OpenapiJobPostResponse) Get() *V0040OpenapiJobPostResponse {
	return v.value
}

func (v *NullableV0040OpenapiJobPostResponse) Set(val *V0040OpenapiJobPostResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableV0040OpenapiJobPostResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableV0040OpenapiJobPostResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0040OpenapiJobPostResponse(val *V0040OpenapiJobPostResponse) *NullableV0040OpenapiJobPostResponse {
	return &NullableV0040OpenapiJobPostResponse{value: val, isSet: true}
}

func (v NullableV0040OpenapiJobPostResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0040OpenapiJobPostResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
