...
// checks if the V0040CronEntry type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0040CronEntry{}
...
func (o V0040CronEntry) ToMap() (map[string]interface{}, error) {
