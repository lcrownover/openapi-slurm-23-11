...
// checks if the V0040KillJobsMsg type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0040KillJobsMsg{}

// V0040KillJobsMsg struct for V0040KillJobsMsg
...
func (o V0040KillJobsMsg) MarshalJSON() ([]byte, error) {
...
func (o V0040KillJobsMsg) ToMap() (map[string]interface{}, error) {
...
type NullableV0040KillJobsMsg struct {
	value *V0040KillJobsMsg
	isSet bool
}

func (v NullableV0040KillJobsMsg) Get() *V0040KillJobsMsg {
	return v.value
}

func (v *NullableV0040KillJobsMsg) Set(val *V0040KillJobsMsg) {
	v.value = val
	v.isSet = true
}

func (v NullableV0040KillJobsMsg) IsSet() bool {
	return v.isSet
}

func (v *NullableV0040KillJobsMsg) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0040KillJobsMsg(val *V0040KillJobsMsg) *NullableV0040KillJobsMsg {
	return &NullableV0040KillJobsMsg{value: val, isSet: true}
}

func (v NullableV0040KillJobsMsg) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0040KillJobsMsg) UnmarshalJSON(src []byte) error {
	v.isSet = true
