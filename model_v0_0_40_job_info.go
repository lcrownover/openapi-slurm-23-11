...
type V0040JobInfo struct {
	...
	Power *V0040JobInfoPower `json:"power,omitempty"`
...
// SetPower gets a reference to the given V0040JobInfoPower and assigns it to the Power field.
