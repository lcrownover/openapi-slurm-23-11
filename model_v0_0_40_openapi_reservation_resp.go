...
// checks if the V0040OpenapiReservationResp type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0040OpenapiReservationResp{}
...
type _V0040OpenapiReservationResp V0040OpenapiReservationResp
...
func (o V0040OpenapiReservationResp) ToMap() (map[string]interface{}, error) {
...
func (o *V0040OpenapiReservationResp) UnmarshalJSON(data []byte) (err error) {
	...
	varV0040OpenapiReservationResp := _V0040OpenapiReservationResp{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varV0040OpenapiReservationResp)

	if err != nil {
		return err
	}

	*o = V0040OpenapiReservationResp(varV0040OpenapiReservationResp)
